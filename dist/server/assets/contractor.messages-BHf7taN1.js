...
import { u as useAuth, D as Route, s as supabase, d as cn, m as motion } from "./router-D7lfUnXG.js";
import { L as LoaderCircle } from "./loader-circle-Cv_0hvwz.js";
import { S as Search } from "./search-BQFunEJp.js";
import { P as Phone } from "./phone-BYmCOu52.js";
import { V as Video, P as Paperclip, S as Smile, a as Send } from "./video-cVQlnefH.js";
...
function ContractorMessages() {
  ...
  reactExports.useEffect(() => {
    if (!user) return;
    const channel = supabase.channel("contractor-messages").on("postgres_changes", {
      event: "INSERT",
      schema: "public",
      table: "messages"
    }, async (payload) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 md:px-6 lg:px-8 pt-6 md:pt-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "Communicate with applicants and hired workers." }),
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12 flex flex-col items-center justify-center gap-3 py-20", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "rounded-3xl bg-card border border-border shadow-soft overflow-hidden flex flex-col", children: activeChat ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm max-w-sm", children: `Select a worker from the sidebar or click "Message" on an applicant's profile to start chatting.` })
      ] }) })
    ] })
  ] });
}
export {
  ContractorMessages as component
};
