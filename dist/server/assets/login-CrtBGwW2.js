...
import { a as useNavigate, f as Route, u as useAuth, m as motion, b as Link, o as objectType, e as stringType, t as toast, s as supabase } from "./router-BN8-Jwly.js";
...
import { A as AuthSplit } from "./auth-split-0tvt8b39.js";
...
import "./users-round-B6ihTVef.js";
import "./arrow-left-_AI6_IRH.js";
...
function Login() {
  ...
  async function handlePhoneSubmit(data) {
    ...
    try {
      ...
      nav({
        to: role === "contractor" ? "/contractor" : "/worker"
      });
    } catch (err) {
