import { a2 as TSS_SERVER_FUNCTION, a7 as getServerFnById, a3 as createServerFn, r as reactExports, W as jsxRuntimeExports } from "./server-D9f26qs9.js";
...
import { A as AnimatePresence } from "./index-BcAwSZkE.js";
import { c as createLucideIcon, m as motion } from "./router-D271R6tG.js";
import { X } from "./x-CtarryAC.js";
import { C as CreditCard } from "./credit-card-DPnbkHxC.js";
import { A as ArrowRight } from "./arrow-right-Ie7HR64i.js";
...
const createRazorpayOrder = createServerFn({
  method: "POST"
}).validator((d) => d).handler(createSsrRpc("e7461c44f7a960556129109463606ff603140d91822a72eff9cadfe0f0efd76e"));
const verifyRazorpayPayment = createServerFn({
  method: "POST"
}).validator((d) => d).handler(createSsrRpc("06cdb36750bf1040ffabb92e8bcad45ba1e26e48a938a24692d2011303b37d08"));
  ...
  const handlePay = async (e) => {
    ...
    if (scriptLoaded) {
      try {
        ...
        console.warn("Could not create real Razorpay order on server. Falling back to simulation.", err);
      }
    }
