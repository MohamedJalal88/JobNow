...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-D0cXn6cX.js");
...
const manifest = {
  "06cdb36750bf1040ffabb92e8bcad45ba1e26e48a938a24692d2011303b37d08": {
    ...
    importer: () => import("./razorpay-B9uVjvYx.js")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-WW3szPP7.js").then((n2) => n2.H),
    import("./start-E96mkZ9I.js"),
