...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DgbcV-jK.js");
...
const manifest = {
  "06cdb36750bf1040ffabb92e8bcad45ba1e26e48a938a24692d2011303b37d08": {
    ...
    importer: () => import("./razorpay-BkH8dNqm.js")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-D271R6tG.js").then((n2) => n2.H),
    import("./start-BCSSuJ9Y.js"),
