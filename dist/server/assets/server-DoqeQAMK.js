...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DMJjDdsC.js");
...
const manifest = {
  "06cdb36750bf1040ffabb92e8bcad45ba1e26e48a938a24692d2011303b37d08": {
    ...
    importer: () => import("./razorpay-CVGPGwbJ.js")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DH6bADvP.js").then((n2) => n2.H),
    import("./start-BPty8jUT.js"),
