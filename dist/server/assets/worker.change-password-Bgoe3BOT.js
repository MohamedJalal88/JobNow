...
import { b as Link, o as objectType, e as stringType, s as supabase, t as toast } from "./router-D7lfUnXG.js";
import { u as useForm, a } from "./zod-SxFQh5Y0.js";
import { B as Button } from "./button-jV6UgcJo.js";
import { I as Input } from "./input-HFzfzB6_.js";
import { L as Label } from "./label-CHQdI1RE.js";
import { A as ArrowLeft } from "./arrow-left-CRkNVaEI.js";
import { K as KeyRound } from "./key-round-CjEznyC1.js";
import { E as EyeOff, a as Eye } from "./eye-1JZxM2nt.js";
import { S as ShieldCheck } from "./shield-check-BMyANN0d.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4 md:px-6 lg:px-8 pt-6 md:pt-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5 rounded-3xl bg-card border border-border shadow-soft overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit(onSubmit), className: "p-6 md:p-8 space-y-5", noValidate: true, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { id: "worker-change-password-submit", type: "submit", disabled: isSubmitting, className: "w-full h-12 rounded-full bg-gradient-primary text-primary-foreground font-semibold shadow-glow", children: isSubmitting ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
