...
import { c as createLucideIcon, u as useAuth, d as cn, t as toast, b as Link, m as motion, s as supabase } from "./router-WW3szPP7.js";
import { B as Badge } from "./badge-BbNRQ_08.js";
import { B as Button } from "./button-DEGIpoY6.js";
import { L as LoaderCircle } from "./loader-circle-BiO1TGvA.js";
import { D as Download } from "./download-BAeWdu37.js";
import { W as Wallet } from "./wallet-CNeHnpJ9.js";
import { T as TrendingUp } from "./trending-up-BIvA3dUb.js";
import { C as Clock } from "./clock-C3Gaonnb.js";
import { I as IndianRupee } from "./indian-rupee-Bp2r5Qgq.js";
import { R as ResponsiveContainer, B as BarChart, C as CartesianGrid, X as XAxis, Y as YAxis, T as Tooltip, a as Bar, A as AreaChart, b as Area } from "./AreaChart-fP407epp.js";
import { A as ArrowUpRight } from "./arrow-up-right-BR9lLehr.js";
...
function Earnings() {
  ...
  const [range, setRange] = reactExports.useState("weekly");
    ...
    async function loadData() {
      ...
      try {
        ...
        const monthlyData = Array.from({
          ...
          const label = `${startD.getDate()} ${startD.toLocaleDateString("en-US", {
            month: "short"
          })} - ${endD.getDate()} ${endD.toLocaleDateString("en-US", {
            month: "short"
          })}`;
          const amt = historyList.filter((h) => h.rawDate >= startD && h.rawDate <= endD).reduce((sum, h) => sum + h.amount, 0);
          return {
            label,
            amt
          };
  ...
  const totalPeriod = reactExports.useMemo(() => activeRangeData.reduce((s, d) => s + d.amt, 0), [activeRangeData]);
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 md:px-6 lg:px-8 pt-6 md:pt-8 flex flex-col items-center justify-center min-h-[60vh]", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Loading earnings details..." })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 md:px-6 lg:px-8 pt-6 md:pt-8 pb-20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end justify-between gap-3 flex-wrap", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl md:text-3xl font-extrabold tracking-tight", children: "Earnings" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "Track your income, pending payouts and payment history." })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { to: "/worker/earnings/total", tone: "from-blue-800 to-slate-900", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Wallet, { className: "h-4 w-4" }), label: "Total earnings", value: `₹${earningsData.total.toLocaleString()}`, sub: "All-time" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { to: "/worker/earnings/monthly", tone: "from-emerald-500 to-teal-600", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "h-4 w-4" }), label: "This month", value: `₹${earningsData.thisMonth.toLocaleString()}`, sub: "Current cycle" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { to: "/worker/earnings/pending", tone: "from-blue-600 to-sky-700", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "h-4 w-4" }), label: "Pending", value: `₹${earningsData.pending.toLocaleString()}`, sub: "Escrow locked" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { to: "/worker/earnings/completed", tone: "from-cyan-600 to-blue-700", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowDownRight, { className: "h-4 w-4" }), label: "Completed", value: `₹${earningsData.completed.toLocaleString()}`, sub: "Paid out" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 grid grid-cols-1 xl:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "xl:col-span-2 rounded-3xl bg-card border border-border p-5 shadow-soft", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3 flex-wrap", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-widest text-muted-foreground", children: "Earnings overview" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-2xl font-extrabold mt-1 inline-flex items-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(IndianRupee, { className: "h-5 w-5" }),
              totalPeriod.toLocaleString()
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
              "Avg ₹",
              avgPeriod.toLocaleString(),
              " / period"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex bg-muted rounded-full p-1", children: RANGES.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setRange(r.id), className: cn("px-3.5 py-1.5 rounded-full text-xs font-semibold transition-all", range === r.id ? "bg-card shadow-soft text-foreground" : "text-muted-foreground"), children: r.label }, r.id)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 h-72", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: range === "weekly" || range === "quarterly" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: activeRangeData, margin: {
          top: 8,
          right: 6,
          left: -16,
          bottom: 0
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Area, { type: "monotone", dataKey: "amt", stroke: "oklch(0.42 0.15 240)", strokeWidth: 2.5, fill: "url(#areaFill)" })
        ] }) }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl bg-gradient-to-br from-blue-800 via-blue-900 to-slate-950 text-white p-6 shadow-elegant relative overflow-hidden", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-widest opacity-80", children: "Payment summary" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs opacity-90 mt-1", children: "Earned this month" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5 space-y-3 relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { label: "Completed", value: `₹${earningsData.completed.toLocaleString()}` }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { label: "Pending", value: `₹${earningsData.pending.toLocaleString()}` }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { label: "Avg per job", value: `₹${(earningsData.allHistory.length > 0 ? Math.round(earningsData.total / earningsData.allHistory.length) : 0).toLocaleString()}` })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "mt-5 w-full rounded-full bg-white text-blue-900 hover:bg-white/90 font-semibold", onClick: () => toast.success("Bank transfer request received!"), children: "Withdraw to bank" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 rounded-3xl bg-card border border-border shadow-soft overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-bold", children: "Payment history" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "All recent earnings, with payout status." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "sm", className: "rounded-full", asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/worker/earnings/completed", children: "View all" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: earningsData.history.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-8 text-center text-sm text-muted-foreground", children: "No recent payment transactions." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: earningsData.history.map((h, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.tr, { initial: {
          opacity: 0,
          y: 6
        }, animate: {
          opacity: 1,
...
function Stat({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to, className: `group block relative overflow-hidden rounded-2xl p-4 text-white bg-gradient-to-br ${tone} shadow-soft hover:shadow-elegant hover:-translate-y-0.5 transition-all`, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "relative mt-2 text-xl md:text-2xl font-extrabold", children: value }),
...
function Row({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-sm", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "opacity-80", children: label }),
