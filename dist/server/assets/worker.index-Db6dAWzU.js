...
import { c as createLucideIcon, u as useAuth, h as useLanguage, m as motion, b as Link, d as cn, s as supabase } from "./router-DgB0XHQ2.js";
...
import { J as JobCard } from "./job-card-CgqByJCy.js";
...
import { A as AnimatePresence } from "./index-DLlEbUmI.js";
import { S as Search } from "./search-ChGMziP7.js";
...
import "./clock-CF8piOhA.js";
import "./users-Cz2ZS11y.js";
...
function WorkerHome() {
  ...
  reactExports.useEffect(() => {
    if (viewMode !== "map" || !leafletLoaded || !LRef.current) {
      if (mapRef.current) {
    ...
    const timer = setTimeout(() => {
      ...
      if (workerLat && workerLng) {
        ...
        L.marker([workerLat, workerLng], {
          icon: L.divIcon({
            ...
            html: '<span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-primary/45 opacity-75"></span><span class="relative inline-flex rounded-full h-3.5 w-3.5 bg-primary border-2 border-white"></span>'
          })
      ...
      filtered.forEach((j) => {
        ...
        L.marker([jobLat, jobLng]).addTo(mapInstance).bindPopup(`
            <div style="font-family: sans-serif; padding: 4px; min-width: 140px;">
              ...
              <div style="display: flex; justify-content: space-between; align-items: center;">
                <span style="font-weight: 700; color: var(--primary); font-size: 12px;">₹${j.payPerDay}/d</span>
                <span style="font-size: 10px; color: #94a3b8;">${j.distanceKm.toFixed(1)} km</span>
              </div>
              <hr style="margin: 8px 0; border: 0; border-top: 1px solid #e2e8f0;"/>
              <a href="/worker/jobs/${j.id}" style="display: block; text-align: center; background: var(--primary); color: white; padding: 5px 8px; border-radius: 9999px; text-decoration: none; font-size: 10px; font-weight: 700;">View Details</a>
            </div>
          `);
      });
  ...
  }, [viewMode, leafletLoaded, workerLat, workerLng, jobs, skill]);
  reactExports.useEffect(() => {
