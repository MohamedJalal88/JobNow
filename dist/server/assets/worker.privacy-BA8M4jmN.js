...
import { b as Link, t as toast } from "./router-BmUDmUT9.js";
...
import { D as Database, C as Cookie, S as ShieldAlert } from "./shield-alert-CU8DPr5_.js";
...
function Privacy() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 md:px-6 lg:px-8 pt-6 md:pt-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/worker/settings", className: "inline-flex items-center gap-1 text-sm text-muted-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "Control how your data is used across JobNow." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { title: "Data preferences", icon: Database, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Toggle, { label: "Personalised job recommendations", desc: "Use your activity to suggest better jobs.", value: prefs.analytics, onChange: (v) => setPrefs((p) => ({
        ...p,
        analytics: v
      })) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Toggle, { label: "Share location for nearby jobs", desc: "Required to show jobs around you.", value: prefs.location, onChange: (v) => setPrefs((p) => ({
        ...p,
        location: v
      })) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Toggle, { label: "Share profile with partners", desc: "Let trusted partner contractors discover you.", value: prefs.share, onChange: (v) => setPrefs((p) => ({
        ...p,
        share: v
      })) })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { title: "Your data", icon: Download, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Action, { title: "Download my data", desc: "Get a copy of everything we have about you.", cta: "Request", onClick: () => toast.success("We'll email your archive within 48h") }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { title: "Danger zone", icon: ShieldAlert, tone: "destructive", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Action, { danger: true, title: "Delete account", desc: "Permanently remove your account and all associated data.", cta: "Delete", onClick: () => toast.error("Account deletion requested") }) })
  ] });
}
function Section({
  title,
