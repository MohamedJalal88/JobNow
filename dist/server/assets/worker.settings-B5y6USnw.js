...
import { u as useAuth, h as useLanguage, b as Link, t as toast, d as cn } from "./router-BN8-Jwly.js";
import { S as Switch } from "./switch-BTb80nJG.js";
import { A as ArrowLeft } from "./arrow-left-_AI6_IRH.js";
import { G as Globe, L as Languages } from "./languages-CZReBNhd.js";
import { U as User } from "./user-Bs5HLWk1.js";
import { M as Mail } from "./mail-DchBCWJj.js";
import { K as KeyRound } from "./key-round-Bm5SidXM.js";
import { W as Wallet } from "./wallet-DYvILPMu.js";
import { M as Moon, C as CircleQuestionMark } from "./moon-DGshVXbJ.js";
import { B as Bell } from "./bell-BY1F6qP7.js";
import { L as Lock } from "./lock-9tm3YrSW.js";
import { T as Trash2 } from "./trash-2-BRqWTyhk.js";
import { C as ChevronRight } from "./chevron-right-TyHim60L.js";
import "node:async_hooks";
import "node:stream/web";
import "node:stream";
import "./index-7MyCOKuU.js";
import "./index-B7y4EU75.js";
import "./index-7ypanOaY.js";
import "./index-656IOo7k.js";
function WorkerSettings() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "min-h-dvh bg-muted/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 md:px-6 lg:px-8 pt-6 md:pt-8 pb-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/worker", className: "inline-flex items-center gap-1 text-sm text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { className: "h-4 w-4" }),
      " Back to dashboard"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-4 text-2xl md:text-3xl font-extrabold tracking-tight", children: t("Worker Settings") }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: t("Manage your account, preferences and security.") }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 grid grid-cols-1 lg:grid-cols-2 gap-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { title: t("Profile"), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { icon: User, label: t("Edit profile"), desc: "Name, skills, photo, contact info", to: "/worker/profile", chevron: true }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { title: t("Account"), children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { icon: KeyRound, label: t("Change password"), to: "/worker/change-password", chevron: true }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { icon: Wallet, label: t("UPI & Bank Details"), desc: t("Manage daily payout bank details"), onClick: () => toast.info(t("UPI and Bank settings coming soon!")), chevron: true })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { title: t("Security & privacy"), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { icon: Lock, label: t("Privacy & data"), to: "/worker/privacy", chevron: true }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { icon: CircleQuestionMark, label: t("Help & support"), to: "/worker/help", chevron: true }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-8 text-center text-xs text-muted-foreground", children: "JobNow Worker Portal v1.0.0" })
  ] }) });
}
function Section({
  title,
