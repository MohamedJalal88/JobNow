  ...
  return (
    <main className="min-h-dvh w-full bg-background overflow-x-hidden">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-8 pt-16 pb-20 md:pt-24 md:pb-28 grid lg:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h1 className="mt-5 text-5xl md:text-6xl xl:text-7xl font-extrabold leading-[1.02] tracking-tight">
              Work near you.<br />
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative rounded-3xl bg-gradient-hero p-1 shadow-elegant">
              <div className="rounded-[22px] bg-card p-6 md:p-8">
                <div className="flex items-center justify-between">
                  ...
                  <span className="inline-flex items-center gap-1.5 text-xs font-medium text-success">
                    <span className="h-2 w-2 rounded-full bg-success animate-pulse" /> 24 jobs open now
                  </span>
                </div>
                <div className="mt-4 space-y-3">
                  {[
                    ...
                    <div key={j.t} className="flex items-center gap-3 p-3 rounded-2xl border border-border hover:shadow-soft transition-shadow">
                      <div className={`h-11 w-11 rounded-xl bg-gradient-to-br ${j.g} grid place-items-center text-white shadow-soft`}>
                        <Briefcase className="h-5 w-5" />
                      </div>
                      <div className="flex-1 min-w-0">
                        <p className="font-semibold text-sm truncate">{j.t}</p>
                        <p className="text-xs text-muted-foreground truncate">{j.c} · {j.d}</p>
                      </div>
      ...
      <section className="pb-20 md:pb-28">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="relative overflow-hidden rounded-[32px] bg-gradient-hero p-10 md:p-16 text-primary-foreground">
            <div className="absolute inset-0 bg-gradient-mesh opacity-60" />
            <div className="relative max-w-3xl">
              <h2 className="text-4xl md:text-6xl font-extrabold tracking-tight">Ready to get to work?</h2>
              <p className="mt-4 text-lg opacity-90">Join 60,000+ workers and contractors building India's most trusted daily wage marketplace.</p>
              <div className="mt-8 flex flex-wrap gap-3">
